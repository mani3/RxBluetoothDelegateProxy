#
# Be sure to run `pod lib lint RxBluetoothDelegateProxy.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'RxBluetoothDelegateProxy'
  s.version          = '0.1.0'
  s.summary          = 'A short description of RxBluetoothDelegateProxy.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'RxBluetoothDelegateProxy' => ['RxBluetoothDelegateProxy/Assets/*.png']
  # }
